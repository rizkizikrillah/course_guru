    ...
    public function run(): void
    {
        ...
        Course::create([
            ...
            'content' => '<ol class="pl-5 space-y-2">
                            <li>(1) Memahami prinsip, merencanakan, melaksanakan, dan melakukan asesmen pembelajaran model PjBL.</li>
                            <li>(2) Memahami prinsip, perencanaan, pelaksanaan, dan asesmen pembelajaran konteks Kelas Industri.</li>
                            <li>(3) Memahami prinsip, merencanakan, melaksanakan, dan melakukan asesmen pembelajaran konteks Kelas Kewirausahaan.</li>
                            <li>(4) Memahami prinsip, merencanakan, melaksanakan, dan melakukan asesmen pembelajaran konteks Tefa.</li>
                            <li>(5) Memahami prinsip, merencanakan, melaksanakan, dan melakukan asesmen mata pelajaran PKL.</li>
                        </ol>',
            'order' => 1,
        ]);
